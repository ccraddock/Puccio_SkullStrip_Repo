...
\title{The Preprocessed Connectomes Project \DIFdelbegin \DIFdel{Repository }\DIFdelend \DIFaddbegin \DIFadd{repository }\DIFaddend of \DIFdelbegin \DIFdel{Manually Corrected Skull-stripped }\DIFdelend \DIFaddbegin \DIFadd{manually corrected skull-stripped }\DIFaddend T1-weighted \DIFdelbegin \DIFdel{Anatomical }\DIFdelend \DIFaddbegin \DIFadd{anatomical }\DIFaddend MRI \DIFdelbegin \DIFdel{Data}\DIFdelend \DIFaddbegin \DIFadd{data}\DIFaddend .}
