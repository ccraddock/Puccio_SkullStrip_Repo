...
\DIFdelend \DIFaddbegin \url{www.preprocessed-connectomes-project.org/NFB\_skullstripped}\DIFaddend . Bash and Python scripts used \DIFdelbegin \DIFdel{for }\DIFdelend \DIFaddbegin \DIFadd{to create the NFBS repository and produce the results and figures in }\DIFaddend this paper are available on GitHub at: \url{https://github.com/preprocessed-connectomes-project/NFB\_skullstripped}. Snapshots of the project and other supporting information is available in the GigaScience repository, GigaDB [33].
